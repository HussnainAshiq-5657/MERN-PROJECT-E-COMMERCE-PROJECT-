  ...
  return (
    <>
      <div className="flex justify-between items-center gap-6 my-20 px-10">
        <div className="w-3/5">
          <img className="w-full h-full object-cover rounded-xl" src={SignUpPagePhoto} alt="Picture of the sign-up page" />
        </div>
                ...
                <div className="flex flex-col gap-6">
                  <div>
                    <input
                      ...
                      onBlur={handleBlur}
                      value={values.email}
                      className="border-b border-b-gray-500 focus:border-none focus:rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 p-2 w-full"
                    />
